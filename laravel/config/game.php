...
return [
    'url'                          => env('GAME_URL', ''),
    'secret'                       => [
        "QPdYdJWSTiQAvCiQeIIc",
        "yjK8evnnKD1quM9Iz4nH",
        "79WByJmchVSIPflxsFXm",
        "KQdKBM6cVFpXab03HdzP",
        "1GNEJNQernNDxDK2cMea",
        "rSvmPhzWh1VBWKzmdkKY",
        "DPhU9fa3TMTyQgeevR0r",
        "qSkVkn61dpL8tvquxs7o",
        "NxN0VvUrJvJD7eN3WcJQ",
        "lnsgcgFKoHdifC6aqAo5",
    ],
    ...
    'api'                          => [
        ...
        "user.by_uid"              => "/back/get_account_info_by_uid",        //通过UID获取账号信息请求
