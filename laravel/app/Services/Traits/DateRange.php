 ...
 * 日期时间范围查询
 * 
 * @method \Illuminate\Database\Eloquent\Builder|$this currentMinute()
 * @method \Illuminate\Database\Eloquent\Builder|$this lastMinute()
 * @method \Illuminate\Database\Eloquent\Builder|$this currentHour()
 * @method \Illuminate\Database\Eloquent\Builder|$this lastHour()
 * @method \Illuminate\Database\Eloquent\Builder|$this currentDay()
 * @method \Illuminate\Database\Eloquent\Builder|$this lastDay()
 * @method \Illuminate\Database\Eloquent\Builder|$this currentWeek()
 * @method \Illuminate\Database\Eloquent\Builder|$this lastWeek()
 * @method \Illuminate\Database\Eloquent\Builder|$this currentMonth()
 * @method \Illuminate\Database\Eloquent\Builder|$this lastMonth()
 * @method \Illuminate\Database\Eloquent\Builder|$this currentYear()
 * @method \Illuminate\Database\Eloquent\Builder|$this lastYear()
 * @method \Illuminate\Database\Eloquent\Builder|$this lastSeconds(int $countSeconds)
 * @method \Illuminate\Database\Eloquent\Builder|$this lastMinutes(int $countMinutes)
 * @method \Illuminate\Database\Eloquent\Builder|$this lastHours(int $countHours)
 * @method \Illuminate\Database\Eloquent\Builder|$this lastDays(int $countDays)
 * @method \Illuminate\Database\Eloquent\Builder|$this lastWeeks(int $countWeeks)
 * @method \Illuminate\Database\Eloquent\Builder|$this lastMonths(int $countMonths)
 * @method \Illuminate\Database\Eloquent\Builder|$this lastYears(int $countYears)
 */
trait DateRange
{
    /**
